...
void averageOfThree(double num1, double num2, double num3) {
...
void main() {
  ...
  celsiusToFahrenheit(double.parse(input!));
  print('\nEnter 3 space-separated numbers to find their average:');
  input = stdin.readLineSync();
  List<double> numbers = input!.split(' ').map((e) => double.parse(e)).toList();
  averageOfThree(numbers[0], numbers[1], numbers[2]);
  checkEvenOdd(7);
